                    ...
                    {item.status?.toLowerCase() === 'pending' ? (
                      <>
                        <button
                          ...
                          className="px-3 py-1.5 bg-[#82c341] hover:bg-[#72ad37] text-[#0c3239] text-xs font-black rounded-xl transition cursor-pointer"
                        >
                          Accepter
                        </button>
                        <button
                ...
                <div key={item.id} className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm space-y-3 flex flex-col justify-between">
                  ...
                  <div className="flex justify-end gap-2 pt-3 border-t border-gray-50">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 text-xs font-bold rounded-xl cursor-pointer"
                    >
                      Supprimer
                    </button>
                  </div>
